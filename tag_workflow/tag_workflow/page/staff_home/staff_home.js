      ...
      html += `
          ...
          order[o].select_job
                  ...
                  order[o].name
								...
								<button type="button" class="btn btn-primary btn-sm ml-3 rounded  text-center" onclick=show_info_order('${
                  order[o].name
                }')>Quick Info</button>
							</div>
						</div>
				...
				<div class="row bg-white quick-info-detail border-bottom py-3">
					...
					<div class="row bg-white quick-info-detail border-bottom py-3">
						...
						<div class="col-lg-3">
							...
							<p class="text-primary">${data[d].job_site_contact}</p>
						</div>
						<div class="col-lg-3">
							<p>No. Of Workers</p>
					...
					<div class="row bg-white quick-info-detail border-bottom py-3">
						<p style="width: 100%;margin-bottom:5px; padding: 4px 15px;"><b>Add Ons</b></p>
						<div class="col-lg-3">
							<p>Drug Screen</p>
...
function order_by() {
  if (this.tagName.toLowerCase() == "a" && this.text != "All") {
    ...
    else args = { company: company1, order_by: this.text };
    frappe.call({
      method:
        "tag_workflow.tag_workflow.page.staff_home.staff_home.filter_category",
      args: args,
...
function filter_category() {
  if (this.tagName.toLowerCase() == "a" && this.text != "All") {
    ...
    else args = { company: company1, category: this.text };
    frappe.call({
      method:
        "tag_workflow.tag_workflow.page.staff_home.staff_home.filter_category",
      args: args,
