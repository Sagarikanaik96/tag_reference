...
class TestAssignEmployee(unittest.TestCase):
	...
	#Pass test case
		loc_1 = get_dest({'street_address':'101 A','city':name_in_upper,'state':name_in_upper,'zip':'10010'})
		self.assertEqual('101 A,New York,New York,10010', loc_1)

		loc_2 = get_dest({'street_address':'101 A','state':name_in_upper,'zip':'10010'})
		self.assertEqual('', loc_2)

		loc_3 = get_dest({'street_address':'101 A','city':'','state':name_in_upper,'zip':'10010'})
		self.assertEqual('101 A,,New York,10010', loc_3)

		loc_4 = get_dest({'street_address':'101 A','city':name_in_lower,'state':name_in_lower,'zip':'10010'})
		self.assertEqual('101 A,new york,new york,10010', loc_4)

	# Fail Test Case
		loc_5 = get_dest({'street_address':'101 A','city':name_in_upper,'state':name_in_upper,'zip':'10010'})
		self.assertEqual('10010,New York,New York,101 A', loc_5)

		loc_6 = get_dest({'street_address':'101 A','state':name_in_upper,'zip':'10010'})
		self.assertEqual('101 A,New York,10010', loc_6)

		loc_7 = get_dest({'street_address':'101 A','city':name_in_lower,'state':name_in_lower,'zip':'10010'})
