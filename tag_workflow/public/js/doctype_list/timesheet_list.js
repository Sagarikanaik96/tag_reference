...
function prepare_timesheet(listview){
	let fields = [
		...
		{fieldtype:'Float', fieldname:'total_hours', label:'Total Hours', in_list_view: 1, read_only: 0},
	];
	...
	var dialog = new frappe.ui.Dialog({
		...
		fields: [
			...
			{fieldtype:'Date', fieldname: 'posting_date', label: "Date", default: frappe.datetime.now_date()},
